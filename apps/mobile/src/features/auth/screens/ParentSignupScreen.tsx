...
import { processParentSignup, isUsernameAvailable } from '../../../shared/services/onboardingService';
...
const ParentSignupScreen: React.FC<ParentSignupScreenProps> = () => {
  ...
  const handleSignup = async () => {
    ...
    setLoading(true);
    try {
      const result = await processParentSignup(invitationCode, {
      ...
      Alert.alert(
        ...
        'Your parent account has been created successfully. You can now log in and register your child for the academy!',
        [
          {
            text: 'Continue',
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            Complete your parent account setup for {invitation.organization_name}
          </Text>
        </View>
        ...
        <View style={styles.form}>
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={styles.usernameContainer}>
              ...
              />
              {checkingUsername && (
                <ActivityIndicator size="small" color={COLORS.accent} style={styles.usernameSpinner} />
              )}
            </View>
            {usernameError ? (
          ...
          <View style={styles.infoBox}>
            ...
            <Text style={styles.infoText}>
              After creating your account, you'll be able to register your child and submit their 
              information for approval by the academy administrator.
            </Text>
          </View>
